...
/**
 * A basic class to represent the smith personality card.
 *
 * @author devinlinux
 */
public class Smith extends Minerva implements PersonalityCard {

    /**
     * Constructor to make a new Smith personality card.
     */
    public Smith() {
        super(Good.TOOL, 3);
    }
